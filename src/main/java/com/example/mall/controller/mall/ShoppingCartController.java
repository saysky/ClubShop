...
public class ShoppingCartController {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/shop-cart")
    ...
    @RequestMapping(method = RequestMethod.POST, value = "/shop-cart")
    @ResponseBody
    ...
    @RequestMapping(method = RequestMethod.PUT, value = "/shop-cart")
    @ResponseBody
    ...
    @RequestMapping(value = "/shop-cart/{mallShoppingCartItemId}", method = RequestMethod.DELETE)
    @ResponseBody
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/shop-cart/settle")

...
public class MessageController {
    ...
    public String messages(
        ...
        // 客户查看管理员,管理员查看第一条消息，
        if (uid == null) {
            if (Constants.USER_ROLE.equalsIgnoreCase(user.getUserType())) {
     ...
     * @return
     */
    @RequestMapping(method = RequestMethod.POST, value = "/message/clear")
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping(method = RequestMethod.GET, value = "/message/notReadCount")
    @ResponseBody

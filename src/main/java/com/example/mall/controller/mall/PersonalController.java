...
public class PersonalController {
    ...
    @RequestMapping(method = RequestMethod.GET, value = {"/active", "active.html"})
    public String activePage() {
        return "mall/active";
    }


    @RequestMapping(method = RequestMethod.GET, value = "/personal/addresses")
...
//        }
    ...
    @RequestMapping(method = RequestMethod.POST, value = "/personal/updateInfo")
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping(method = RequestMethod.POST, value = "/updatePayPassword")
    @ResponseBody

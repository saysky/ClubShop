...
public class GoodsController {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/goods/detail/{goodsId}")
     ...
     * @return
     */
    @RequestMapping(method = RequestMethod.POST, value = "/goods/mark")
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping(method = RequestMethod.POST, value = "/goods/unmark")
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping(method = RequestMethod.POST, value = "/goods/comment")
    @ResponseBody
    @Transactional

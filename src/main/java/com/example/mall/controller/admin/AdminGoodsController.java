...
public class AdminGoodsController {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/goods/edit")
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/goods/edit/{goodsId}")
     ...
     * 详情
     */
    @RequestMapping(method = RequestMethod.GET, value = "/goods/info/{id}")
    @ResponseBody

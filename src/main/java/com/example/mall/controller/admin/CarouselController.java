...
public class CarouselController {
    ...
    @Autowired
    CarouselService mallCarouselService;

    @RequestMapping(method = RequestMethod.GET, value = "/carousels")
     ...
     * 详情
     */
    @RequestMapping(method = RequestMethod.GET, value = "/carousels/info/{id}")
    @ResponseBody

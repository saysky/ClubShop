...
//    }
    ...
    public String profile(HttpServletRequest request) {
        ...
        if (adminUser == null || Constants.USER_ROLE.equalsIgnoreCase(adminUser.getUserType())) {
            return "admin/login";
        }
    ...
    @RequestMapping(method = RequestMethod.POST, value = "/profile/password")
    @ResponseBody
...
//        request.getSession().removeAttribute("errorMsg");
    ...
    @RequestMapping(method = RequestMethod.POST, value = "/profile/name")
    @ResponseBody
    ...
    public String logout(HttpServletRequest request) {
        request.getSession().removeAttribute("loginUserId");
        request.getSession().removeAttribute("mallUser");
        request.getSession().removeAttribute("errorMsg");
        return "redirect:/";
    }
}

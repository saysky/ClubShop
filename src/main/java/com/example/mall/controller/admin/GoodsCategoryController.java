...
public class GoodsCategoryController {
    ...
    public String categoriesPage(HttpServletRequest request, @RequestParam("categoryLevel") Integer categoryLevel, @RequestParam("parentId") Long parentId, @RequestParam("backParentId") Long backParentId) {
     ...
     * 详情
     */
    @RequestMapping(method = RequestMethod.GET, value = "/categories/info/{id}")
    @ResponseBody

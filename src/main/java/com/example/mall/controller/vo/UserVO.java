...
public class UserVO implements Serializable {
    ...
    private Integer shopCartTotalAmount;
    ...
    public Integer getShopCartTotalAmount() {
        return shopCartTotalAmount;
    }

    public void setShopCartTotalAmount(Integer shopCartTotalAmount) {
        this.shopCartTotalAmount = shopCartTotalAmount;
    }

...
public class Constants {
    // 修改上传目录
    public final static String FILE_UPLOAD_DIC = "/Users/liuyanzhao/Desktop/shop/031-ClubShop/源码/upload/";//上传文件的默认url前缀，根据部署设置自行修改
    ...
    public final static int MARK_PAGE_LIMIT = 5; // 收藏，每页5个

    public final static int SELL_STATUS_UP = 0;//商品上架状态
    public final static int SELL_STATUS_DOWN = 1;//商品下架状态


    public final static String USER_ROLE = "user";//用户角色
    public final static String ADMIN_ROLE = "admin";//俱乐部管理员角色
    public final static String SUPER_ADMIN_ROLE = "super_admin";//超级管理员角色

    public final static Long ADMIN_USER_ID = 1L;//管理员ID
